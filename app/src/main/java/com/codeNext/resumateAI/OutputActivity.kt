...
import com.codeNext.resumateAI.databinding.ActivityOutputBinding
...
//            }
        ...
        binding.ivEdit.setOnClickListener {
            ...
            if (isEditing) {
                ...
                binding.ivEdit.setImageResource(com.codeNext.resumateAI.R.drawable.icon_tick) // Edit mode image
            } else {
                ...
                binding.ivEdit.setImageResource(com.codeNext.resumateAI.R.drawable.icon_write) // Default image
...
//            }
    ...
    private fun updateNavigationRailSelection(index: Int) {
        ...
        val menuItems = listOf(
            com.codeNext.resumateAI.R.id.nav_objective_output,
            com.codeNext.resumateAI.R.id.nav_projects_output,
            com.codeNext.resumateAI.R.id.nav_experience_output,
        )
    ...
    private fun setupNavigationRail() {
        ...
        navigationRailView.setOnItemSelectedListener { item ->
            ...
            val targetIndex = when (item.itemId) {
                com.codeNext.resumateAI.R.id.nav_objective_output -> OBJECTIVE_INDEX
                com.codeNext.resumateAI.R.id.nav_projects_output -> PROJECTS_INDEX
                com.codeNext.resumateAI.R.id.nav_experience_output -> EXPERIENCE_INDEX
